...
?>
    <ul class="nav nav-tabs">
        <li role="presentation" class="<?=yii::$app->request->get('index',1)==1?'active':''?>"><?=Html::a('登录',['/manage/help'])?></li>
        <li role="presentation" class="<?=yii::$app->request->get('index',1)==2?'active':''?>"><?=Html::a('头部导航',['/manage/help?index=2'])?></li>
        <li role="presentation" class="<?=yii::$app->request->get('index',1)==3?'active':''?>"><?=Html::a('首页结构',['/manage/help?index=3'])?></li>
