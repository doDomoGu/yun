...
?>
    <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="<?=yii::$app->request->get('index',1)==5?'active':''?>"><?=Html::a('目录权限',['/manage/help?index=5'])?></li>
        <li role="presentation" class="<?=yii::$app->request->get('index',1)==6?'active':''?>"><?=Html::a('公司职员',['/manage/help?index=6'])?></li>
        <li role="presentation" class="<?=yii::$app->request->get('index',1)==7?'active':''?>"><?=Html::a('管理员授权',['/manage/help?index=7'])?></li>
        <li role="presentation" class="<?=yii::$app->request->get('index',1)==8?'active':''?>"><?=Html::a('消息通知',['/manage/help?index=8'])?></li>
    </ul>