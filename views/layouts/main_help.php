...
<div class="wrap">
    ...
    <div class="container">
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="<?=yii::$app->request->get('index',1)==6?'active':''?>"><?=Html::a('职员资料',['/help?index=6'])?></li>
            <li role="presentation" class="<?=yii::$app->request->get('index',1)==7?'active':''?>"><?=Html::a('消息通知',['/help?index=7'])?></li>
        </ul>
        <?= $content ?>
    </div>
</div>
