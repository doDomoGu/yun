...
class Position3 extends \yii\db\ActiveRecord
{
    public $childrenIds;
    public $childrenList;
...
/*ALTER TABLE `position` ADD `full_alias` VARCHAR(255) DEFAULT NULL AFTER `alias`;*/
    ...
    public function __construct(){
        ...
        $this->arr = [
            ...
            ['n'=>'颂唐机构','a'=>'stjg','c'=>[
                ['n'=>'发展管控中心','a'=>'fzgkzx','c'=>$this->zhiji_zhongxin],
                ['n'=>'行政管控中心','a'=>'xzgkzx','c'=>$this->zhiji_zhongxin],
                ['n'=>'财务管控中心','a'=>'cwgkzx','c'=>$this->zhiji_zhongxin],
                ['n'=>'企宣管控中心','a'=>'qxgkzx','c'=>$this->zhiji_zhongxin],
                ['n'=>'市场策略中心','a'=>'scclzx','c'=>$this->zhiji_zhongxin],
                ['n'=>'上海','a'=>'sh','c'=>[
                    ['n'=>'综合管理部','a'=>'zhglb','c'=>$this->zhiwei_zgb],
                    ['n'=>'财务部','a'=>'cwb','c'=>$this->zhiwei_cwb],
